...
public enum ResourceKind { LocalFile, Http, Environment, Secret, Configuration, Sql, Module }
...
public sealed record ConfigurationResourceReference(string Key) : ResourceReference(ResourceKind.Configuration, $"config:{Key}");
