...
namespace FluNET.Syntax.Verbs
{
        ...
        IUsing<TUsing>
    {
        ...
        /// For TRANSFORM verbs, expects either a USING keyword, a WHAT noun, a variable, or a literal value.
        /// </summary>
        ...
        /// <summary>
        /// Invokes the TRANSFORM operation and returns the transformed data.
        /// </summary>
