...
{
    public WhatAttribute() : base(ClauseKind.What) { }
}

public sealed class FromAttribute : RoleAttribute
{
    public FromAttribute() : base(ClauseKind.From) { }
}

public sealed class ToAttribute : RoleAttribute
{
    public ToAttribute() : base(ClauseKind.To) { }
}

public sealed class UsingAttribute : RoleAttribute
{
    public UsingAttribute() : base(ClauseKind.Using) { }
}

public sealed class WithAttribute : RoleAttribute
{
    public WithAttribute() : base(ClauseKind.With) { }
}

public sealed class ThenAttribute : RoleAttribute
{
    public ThenAttribute() : base(ClauseKind.Then) { }
}
