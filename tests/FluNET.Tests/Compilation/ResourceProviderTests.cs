...
public sealed class ResourceProviderTests
{
    ...
    public void RuntimeRegistersBuiltInResourceProviders()
    {
        ...
        Assert.That(providers.Providers.Select(item => item.Id), Is.SupersetOf(new[]
        {
            "core.file",
            "core.http",
            "core.environment",
    ...
    public void ModuleCanRegisterProviderWithoutChangingSurfaceLowerer()
    {
        ...
        builder.AddModule(new StandardLanguageModule())
            .AddModule(new SurfaceLanguageModule())
            .ResourceProvider<DemoProvider>();
        ...
        ResourceDescriptor descriptor = new(
            new ModuleResourceReference("demo", "value"),
            ResourceFormat.Unknown,
            runtime.Language.Types.Object,
            "value");
    ...
    public sealed class DemoProvider : IResourceProvider
    {
        ...
        public bool CanHandle(ResourceDescriptor descriptor) =>
            descriptor.Reference is ModuleResourceReference module && module.Scheme == "demo";
        public ResourceProviderResult LowerRead(ResourceProviderContext context) =>
            ResourceProviderResult.Error("TEST", "not executed");
    }
}
